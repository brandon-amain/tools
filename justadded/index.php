<div class="col-sm-12">
	<div class="row">
		...
		<div class="col-sm-12">
			<form action="recentlyadded.php" method="POST">
				<div class="form-row">
					<h3>Product 1</h3>
			    	<div class="col-sm-4">
			  	...
			  	<div class="form-row">
					<h3>Product 5</h3>
			    	<div class="col-sm-4">
			     		<input type="text" class="form-control" placeholder="Product Title" maxlength="58" name="title5">
			    	</div>
			    	<div class="col-sm-4">
			      		<input type="text" class="form-control" placeholder="Product Image Link" name="image5">
			    	</div>
			    	<div class="col-sm-4">
			      		<input type="text" class="form-control" placeholder="Product Link" name="link5">
			    	</div>
			    	<br /><br />
			  	</div>
			  	<div class="form-row">
					<h3>Product 6</h3>
			    	<div class="col-sm-4">
			     		<input type="text" class="form-control" placeholder="Product Title" maxlength="58" name="title6">
			    	</div>
			    	<div class="col-sm-4">
			      		<input type="text" class="form-control" placeholder="Product Image Link" name="image6">
			    	</div>
			    	<div class="col-sm-4">
			      		<input type="text" class="form-control" placeholder="Product Link" name="link6">
			    	</div>
			    </div>
			    <br /><br />
			    <div class="form-row">
